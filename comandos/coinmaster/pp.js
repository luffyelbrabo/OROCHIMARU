...
module.exports = {
  ...
  exec: async (m, { sock }) => {
    try {
      ...
      // Consulta todos que já cadastraram vila (com Promise para usar await)
      ...
      if (naoCadastrados.length === 0) {
        return await sock.sendMessage(m.chat, { text: '✅ Todos os membros já cadastraram suas vilas!' }, { quoted: m });
      }
